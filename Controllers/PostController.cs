...
namespace ToDoITS.Controllers
{
    public class PostController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,PostText")] Post post)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PostText")] Post post)
        {
            if (id != post.Id)
            {
                return NotFound();
